...
// File: contracts/btswap.sol

// SPDX-License-Identifier: BTswap.com

/**
 * @author  BTswap.Team
 *
 * @dev     Contract for BTswap token with burn support
 */
...
// BTswap erc20 Token Contract.
contract BTswap is DeligateERC20, Ownable {
    uint256 private constant preMineSupply  = 101357 * 1e2 * 1e18;       // pre-mine
    uint256 private constant maxSupply      = 120 * 1e6 * 1e18;     // the total supply
    ...
    constructor() public ERC20("BTswap Token", "BT") {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "BTswap: _addMinter is the zero address");

        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "BTswap: _delMinter is the zero address");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "BTswap: caller is not the minter");
        _;
    }
}
